task_index_list=("4 5 6 7 8 10 11 15 17 18 22 23 25 27 28 29 30 33 34"
"0 3 6 7 8 9 17 19 20 21 23 26 28 29 33 34 35 36 37"
"0 2 4 5 7 8 12 13 19 21 22 23 28 29 30 31 32 33 34"
"1 5 8 9 10 14 15 16 19 20 21 23 25 28 29 30 34 35 36"
...
python custom_train_alpaca.py --model_key "TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T"\
    ...
    --strategy auto --devices 1 --runs 1 --precision "bf16-true" --accumulate 1 --save_name sample_quantized_training\
