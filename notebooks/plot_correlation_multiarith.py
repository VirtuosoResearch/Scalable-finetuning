...
l1 = [0.6473466050537255]
l2 = [0.2632591099893588]
l3 = [0.1672165498124423]
l4 = [0.11632591099893588]
...
# ax.set_xticks([ 0,  5, 10, 18.5])
ax.xaxis.set_ticks_position('none') 
ax.set_xticklabels([], rotation = 20)
plt.yticks(np.arange(0.0, 0.9, 0.2))
# plt.ylim([0.48, 0.82])

plt.legend([rects5, rects4, rects2, rects1], methods, fontsize=28, loc='upper left')

plt.tick_params(axis='x')
plt.title(r'$\mathrm{MultiArith}$', fontsize=40)
...
plt.tight_layout()
plt.savefig('./figures/correlation_comparison_multiarith.pdf', dpi=300, bbox_inches='tight', format='pdf')