...
l1 = [0.7145274308997558]
l2 = [0.232591099893588]
l3 = [0.172165498124423]
l4 = [0.132591099893588]
...
plt.title(r'$\mathrm{SVAMP}$', fontsize=40)
...
plt.tight_layout()
plt.savefig('./figures/correlation_comparison_svamp.pdf', dpi=300, bbox_inches='tight', format='pdf')