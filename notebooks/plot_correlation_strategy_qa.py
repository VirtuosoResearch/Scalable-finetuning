...
l1 = [0.6595162292100721]
l2 = [0.1232591099893588]
l3 = [0.06000958391779287]
l4 = [0.03527008255473829]
...
plt.title(r'$\mathrm{Strategy~QA}$', fontsize=40)
...
plt.tight_layout()
plt.savefig('./figures/correlation_comparison_strategy_qa.pdf', dpi=300, bbox_inches='tight', format='pdf')