...
class MultitaskDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {"task_name": task_name, "data": self.task_to_datasets[task_name][sample_id]}
...
class MultitaskBatchSampler(BatchSampler):
    ...
    def __iter__(self):
        ...
        all_indices = self._gen_task_indices(self._train_data_list, mix_opt= (0.5 if self.shuffle else 1))
    ...
    def _gen_task_indices(train_data_list, mix_opt = 0.5, extra_task_ratio = 0):
        ...
        else: # by default, enter this branch
...
class MultitaskCollator:
    ...
    def __call__(self, batch):
        ...
        batch = [sample['data'] for sample in batch]
