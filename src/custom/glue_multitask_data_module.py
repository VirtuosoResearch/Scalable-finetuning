...
class GLUEMultitaskDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.multitask_train_sampler = MultitaskBatchSampler(self.task_to_train_datasets, self.batch_size, shuffle=True)
        self.multitask_valid_sampler = MultitaskBatchSampler(self.task_to_valid_datasets, self.inference_batch_size, shuffle=False)
